    ...
    let newItem = (
      <div className="row" key="1">
        ...
        <div className="col-md-5 quote">
          <div className="quotebefore">مدیر استودیو الزهرا VFX</div>
          <div className="quote-name">
            با همه این مشکلات امروز به مرحله‌ای رسیده‌ایم که به ما اعتماد بیشتری
            می‌شود. امروز پیشنهاداتی جذاب به ما ارائه می‌شود که متن‌های خوبی
            دارند. شخصاً آینده این صنعت را در ایران بسیار روشن می‌بینم. فراز و
            نشیب‌هایی وجود دارد؛ ولی مسیر ما در این صنعت رو به جلو است. خدا را
            شکر این مسیر آن قدری رو به رشد است که ما به فکر مهاجرت از کشور
            نباشیم.
          </div>
        </div>
      </div>
